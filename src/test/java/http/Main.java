...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
     /*   ObjectMapper objectMapper = new ObjectMapper();
        String json="D:\\Terry\\cloud\\OneDrive\\data\\huanshoulv_raw\\pie\\20160608\\000008.json";
        ApiResult result = objectMapper.readValue(new FileInputStream(json), ApiResult.class);*/

      //  CommandUtils.executeCommand("python D:\\Terry\\workspace\\turnover\\python\\get_stock_basics.py");
